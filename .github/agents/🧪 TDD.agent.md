...
tools: ['execute/testFailure', 'read/problems', 'read/readFile', 'agent', 'edit', 'search', 'playwright/*', 'github/*']
---
...
3. **After Phase 1 completes, call `runSubagent` for Phase 2:**
   - Only proceed if Phase 1 has a failing test
   - Now implement the feature
   - Return when implementation is complete

4. **After Phase 2 completes, call `runSubagent` for Phase 3:**
